 ...
 * @author Eder
 */
public class relProdutoOrdem extends HttpServlet {
...
//formata a data para o formato MM/dd/yyyy
        ...
        String relJasper = path + "/relProdutoOrdem.jasper";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(relDespesa.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
