 ...
 * @author Eder
 */
public class relOrdemProdutoComprado extends HttpServlet {
...
//formata a data para o formato MM/dd/yyyy
        ...
        String relJasper = path + "/relOrdemProdutoComprado.jasper";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(relOrdemProdutoComprado.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
