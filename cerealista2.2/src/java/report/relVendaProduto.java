 ...
 * @author Eder
 */
public class relVendaProduto extends HttpServlet {
...
//formata a data para o formato MM/dd/yyyy
        ...
        String relJasper = path + "/relVendaProduto.jasper";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(relVendaProduto.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
